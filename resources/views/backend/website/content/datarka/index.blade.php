                    ...
                    <div class="row">
                                        ...
                                        <tbody>
                                            @foreach ($datarka as $key => $datarkas)
                                                <tr>
                                                    <td></td>
                                                    <td> {{$key+1}} </td>
                                                    <td> <img src="{{asset('storage/images/slider/' .$datarkas->image)}}" class="img-responsive" style="max-width: 50px; max-height:50px"> </td>
                                                    <td> {{$datarkas->is_active == '0' ? 'Aktif' : 'Tidak Aktif'}} </td>
                                                    <td>
                                                        <a href=" {{route('backend-datarka.edit', $datarkas->id)}} " class="btn btn-success btn-sm">Edit</a>
                                                    </td>
                                                </tr>
                                            @endforeach
                                        </tbody>                                   
                        ...
                        <div class="col-6">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form action=" {{route('backend-datarka.store')}} " method="post" enctype="multipart/form-data">
                                        @csrf
                                        <div class="row">
                                            <div class="col-6">
